      ...
      <div className="max-w-[600px] mx-auto text-center relative z-[1]">
        <Reveal>
          ...
          <p className="text-[13px] text-neutral-600 mb-10 leading-relaxed max-w-[420px] mx-auto">
            Get exclusive deals, latest arrivals and tech news straight to your inbox.
            No spam, ever.
          </p>
          ...
          <div className="flex justify-center gap-6 mb-10">
            {[
              { icon:"M5 13l4 4L19 7", label:"Exclusive deals" },
              { icon:"M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9", label:"New arrivals first" },
              { icon:"M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z", label:"No spam" },
            ].map(({ icon, label }) => (
          ...
          {status === "success" ? (
            ...
            <div className="flex flex-col items-center gap-3 py-4">
              ...
              <p className="text-white font-bold text-[15px]">You're in! 🎉</p>
              <p className="text-neutral-600 text-xs">Check your inbox for a welcome surprise.</p>
            </div>
